<?php
    ...
    class Utility {
        ...
        public function rootDirectory($user_id){
            return("UserAccounts/".$user_id);
        }
        public function getUploadDirectory($user_id){
            $rootDir='UserAccounts';
            return($rootDir.'/'.$user_id.'/Uploads');
        }    

        public function getProfilePicPath_32($user_id){
            
            $profilePath = $this->rootDirectory($user_id).'/Profile/thumbs_32/proPic.png';            
        ...
        public function getProfilePicPath_96($user_id){
            $profilePath = $this->rootDirectory($user_id).'/Profile/thumbs/proPic.png';
            if(file_exists($profilePath)) {
                return $profilePath;
            } else {
        ...
        public function output_infoMessage($message){
            //$message = '';
        ...
        public function output_errorMessage($message){
            //$message = '';
            //foreach($messages as $message){
                $message = '<p style="padding: 0.833em 0.833em 0.833em 3em; 
                margin-bottom: 0.833em;
